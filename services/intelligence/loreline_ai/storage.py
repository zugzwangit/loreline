...
class ObjectStore:
    def __init__(self, cfg: Settings):
        ...
        self.client=boto3.client("s3",endpoint_url=cfg.object_endpoint,aws_access_key_id=cfg.object_access_key,aws_secret_access_key=cfg.object_secret_key,config=Config(signature_version="s3v4"),region_name="us-east-1") if self.enabled else None
