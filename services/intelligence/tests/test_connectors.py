...
class ConnectorTests(unittest.TestCase):
    ...
    def test_generic_json_mapping_and_cursor(self,get):
        ...
        connector=HTTPJSONConnector({"url":"https://example.test/api","content_path":"body","cursor_path":"next","credential_env":"LORELINE_CONNECTOR_TEST_TOKEN"},cfg)
    ...
    def test_rejects_unapproved_host_and_credential_name(self):
        ...
        with self.assertRaisesRegex(ValueError,"not in LORELINE_CONNECTOR_ALLOWED_HOSTS"):
            HTTPJSONConnector({"url":"https://metadata.invalid/api","credential_env":"LORELINE_CONNECTOR_TOKEN"},cfg)
